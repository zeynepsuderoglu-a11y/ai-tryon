...
import { tryonApi, geminiTryonApi, backgroundReplaceApi, mannequinTryonApi } from "@/lib/api";
      ...
      try {
        if (generationId) {
          const gen = statusEndpoint === "ai-pro"
            ...
            : statusEndpoint === "mannequin-tryon"
            ? await mannequinTryonApi.getStatus(generationId)
