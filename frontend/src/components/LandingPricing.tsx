    ...
    <section id="fiyatlandirma" className="py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-4xl sm:text-5xl font-bold text-center text-white mb-3 tracking-tight">
          Esnek <span style={{ background: "linear-gradient(135deg, #f0abfc, #c084fc)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Fiyatlandırma</span>
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-10">
          {PLANS.map((plan) => (
            <div
              ...
              style={
                plan.popular
                  ? { background: "linear-gradient(135deg, rgba(168,85,247,0.2), rgba(236,72,153,0.1))", border: "1px solid rgba(168,85,247,0.5)" }
                  : { background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)" }
              }
            >
              {plan.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <span className="text-[10px] font-bold px-3 py-1 rounded-full text-white whitespace-nowrap" style={{ background: "linear-gradient(135deg, #a855f7, #ec4899)" }}>
                    En Popüler
                  </span>
                </div>
              )}
              ...
              <div className="mb-4">
                ...
                {plan.credits && (
                  <div className="mt-2 flex items-center gap-1.5">
                    <span className="w-2 h-2 rounded-full" style={{ background: plan.popular ? "#c084fc" : "#6b7280" }} />
