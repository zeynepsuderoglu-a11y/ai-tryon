    ...
    <div className="min-h-screen text-white" style={{ background: "#080810" }}>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-16 pb-16 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] rounded-full opacity-20 blur-[120px]" style={{ background: "radial-gradient(circle, #7c3aed 0%, #db2777 60%, transparent 100%)" }} />
        </div>

        <div className="relative max-w-4xl mx-auto text-center z-10">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-8 text-sm" style={{ background: "rgba(124,58,237,0.15)", border: "1px solid rgba(124,58,237,0.3)", color: "#c084fc" }}>
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight mb-4 leading-tight">
            ...
            <span style={{ background: "linear-gradient(135deg, #f0abfc 0%, #c084fc 50%, #818cf8 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
      ...
      <section id="hizmetler" className="py-24 px-6" style={{ background: "rgba(255,255,255,0.02)" }}>
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-white mb-3 tracking-tight">
            Kapsamlı <span style={{ background: "linear-gradient(135deg, #f0abfc, #c084fc)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>AI Çözümleri</span>
          </h2>
              ...
              >
                ...
                <div className="mt-3">
                  <p className="text-xs font-medium mb-0.5" style={{ color: "#9ca3af" }}>
                    {s.title} <span className="mx-1 opacity-40">/</span> <span style={{ color: "#c084fc" }}>{s.tag}</span>
                  </p>
      ...
      <section className="py-24 px-6 text-center relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] rounded-full opacity-15 blur-[100px]" style={{ background: "radial-gradient(circle, #7c3aed 0%, #db2777 100%)" }} />
        </div>
