...
import { BarChart3, Users, ImageIcon, LogOut, KeyRound, Layers, Wand2, UserPlus } from "lucide-react";
import { cn } from "@/lib/utils";

const navItems = [
  { href: "/admin",             label: "Genel Bakış",    icon: BarChart3  },
  { href: "/admin/users",       label: "Kullanıcılar",   icon: Users      },
  { href: "/admin/registrations", label: "Kayıt Girişimleri", icon: UserPlus   },
